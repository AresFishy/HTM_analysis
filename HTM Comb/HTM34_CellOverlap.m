...
for day = 1:7
    for animal = 1:9
        toneCellFraction(animal,day) = length(toneCells{animal,day}) / size(ieg_exp{animal,1},1);
        gratCellFraction(animal,day) = length(gratCells{animal,day}) / size(ieg_exp{animal,1},1);
        puffCellFraction(animal,day) = length(puffCells{animal,day}) / size(ieg_exp{animal,1},1);
        rewCellFraction(animal,day) = length(rewCells{animal,day}) / size(ieg_exp{animal,1},1); 
