...
%                 toneAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                toneAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
...
%                 tone1Act{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                tone1Act{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
...
%                 tone2Act{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                tone2Act{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
            %Grating Activity
...
%                 gratAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                gratAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
...
%                 grat1Act{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                grat1Act{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
...
%                 grat2Act{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                grat2Act{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
...
%                 aPuffAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                aPuffAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
...
%                 pPuffAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                pPuffAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
...
%                 rewAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                rewAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
...
%                 pRewAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20) - mean(act{animal,day}(cell,tmpON-10:tmpON-1));
                pRewAct{animal,day}(trial,cell,:) = act{animal,day}(cell,tmpON-10:tmpON+20);
            end
        end
    end
end
...
for day = days
    for animal = animals
        ...
        if ~isempty(act{animal,day})
            mToneAct{animal,day} = squeeze(mean(toneAct{animal,day}(1:end,:,:),1));
            mTone1Act{animal,day} = squeeze(mean(tone1Act{animal,day}(1:end,:,:),1));
            mTone2Act{animal,day} = squeeze(mean(tone2Act{animal,day}(1:end,:,:),1));
            
            mGratAct{animal,day} = squeeze(mean(gratAct{animal,day}(1:end,:,:),1));
            mGrat1Act{animal,day} = squeeze(mean(grat1Act{animal,day}(1:end,:,:),1));
            mGrat2Act{animal,day} = squeeze(mean(grat2Act{animal,day}(1:end,:,:),1));
            
            maPuffAct{animal,day} = squeeze(mean(aPuffAct{animal,day}(1:end,:,:),1));
            mpPuffAct{animal,day} = squeeze(mean(pPuffAct{animal,day}(1:end,:,:),1));
            if ~isempty(rewAct{animal,day})
                mRewAct{animal,day} = squeeze(mean(rewAct{animal,day}(1:end,:,:),1));
            else
                mRewAct{animal,day} = NaN(size(act{animal,day},1),31);
            end
            if ~isempty(pRewAct{animal,day})
                mpRewAct{animal,day} = squeeze(mean(pRewAct{animal,day}(1:end,:,:),1));
            else
